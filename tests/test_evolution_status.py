...
class EvolutionStatusTests(unittest.TestCase):
    ...
    def test_prepare_evolution_payload_splits_bip3_cutover_period(self) -> None:
        ...
        self.assertEqual(
            ...
            ["2025-Q4", "2026-Jan12", "2026-Jan12Q1"],
        )
        self.assertEqual(payload["meta"]["first_period"], "2025-Q4")
        self.assertEqual(payload["meta"]["last_period"], "2026-Jan12Q1")
        self.assertEqual(payload["meta"]["milestones"], [{"date": "2026-01-12", "label": "BIP3 Activation"}])

        segmented_rows = {
            row["period"]: row for row in payload["status_evolution_segmented"]["rows"]
        }
        ...
        self.assertEqual(segmented_rows["2026-Jan12"]["values"]["bip3:Draft"], 1)
        self.assertEqual(segmented_rows["2026-Jan12"]["values"]["bip3:Deployed"], 1)
        self.assertEqual(segmented_rows["2026-Jan12"]["values"]["bip3:Complete"], 1)
        self.assertEqual(segmented_rows["2026-Jan12Q1"]["values"]["bip3:Draft"], 1)
        self.assertEqual(segmented_rows["2026-Jan12Q1"]["values"]["bip3:Deployed"], 1)
        self.assertEqual(segmented_rows["2026-Jan12Q1"]["values"]["bip3:Complete"], 1)
    ...
    def test_prepare_evolution_payload_does_not_project_bip3_before_harvested_transition(self) -> None:
        ...
        self.assertEqual(segmented_rows["2025-Q4"]["values"]["bip2:Draft"], 1)
        self.assertEqual(segmented_rows["2026-Jan12"]["values"]["bip2:Draft"], 1)
        self.assertEqual(segmented_rows["2026-Jan12"]["values"]["bip3:Draft"], 0)
        self.assertEqual(segmented_rows["2026-Jan12Q1"]["values"]["bip3:Draft"], 1)
